...
direct = ''
date = ''
output = "cvar_lognormal_objcoef.txt"
...
for N in N_list:
    ...
    for obj_coef in obj_coef_list:
        ...
        pickle.dump(results_eval_all, open(direct + date +  "results_eval_cvar_lognormal_objcoef.pkl", "wb"))
        pickle.dump(risk_all, open(direct + date +  "risk_cvar_lognormal_objcoef.pkl", "wb"))
        pickle.dump(feature_split_all, open(direct + date +  "feature_split_cvar_lognormal_objcoef.pkl", "wb"))
