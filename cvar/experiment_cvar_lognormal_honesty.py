...
direct = ''
date = ''
output = "cvar_lognormal_honesty.txt"
...
for N in N_list:
    ...
    for obj_coef in obj_coef_list:
        ...
        time1 = time.time()
        results_fit = Parallel(n_jobs=n_jobs, verbose = 3)(delayed(compare_forest_honesty)(X_list[run], Y_list[run], X_list[run], Y_list[run], 
        ...
        pickle.dump(results_eval_all, open(direct + date +  "results_eval_cvar_lognormal_honesty.pkl", "wb"))
        pickle.dump(risk_all, open(direct + date +  "risk_cvar_lognormal_honesty.pkl", "wb"))
        pickle.dump(feature_split_all, open(direct + date +  "feature_split_cvar_lognormal_honesty.pkl", "wb"))
