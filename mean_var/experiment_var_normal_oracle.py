...
direct = '/data/xm77/forest/'
date = '09_03/'
output = "var_normal_oracle.txt"
...
for N in N_list:
    # rel_risk_all[str(N)] = {}
    # results_fit_all[str(N)] = {}
    risk_all[str(N)] = {}
    cond_sharpe_all[str(N)] = {}
    marginal_sharpe_all[str(N)] = {}
    ...
    for obj_coef in obj_coef_list:
        ...
        time2 = time.time()
        # results_fit_all[str(N)][str(obj_coef)] = results_fit
        with open(output, 'a') as f:
        ...
        pickle.dump(results_eval_all, open(direct + date +  "results_eval_var_normal_oracle.pkl", "wb"))
        pickle.dump(risk_all, open(direct + date +  "risk_var_normal_oracle.pkl", "wb"))
        pickle.dump(feature_split_all, open(direct + date +  "feature_split_var_normal_oracle.pkl", "wb"))
